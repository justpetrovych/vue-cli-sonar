<template>
  <div class="hello">
    ...
    <ul>
      ...
      <li><a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-pwa" target="_blank" rel="noopener noreferrer">pwa</a></li>
      ...
      <li><a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-unit-jest" target="_blank" rel="noopener noreferrer">unit-jest</a></li>
    </ul>
